...
#
# A workspace link resolves @tev-ui/ui straight to packages/ui, bypassing the
...
import { Badge } from "@tev-ui/ui/primitives/Badge";
import { Table, TableBody, TableCell, TableRow } from "@tev-ui/ui/primitives/Table";
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@tev-ui/ui/primitives/Tooltip";
import { Calendar } from "@tev-ui/ui/primitives/Calendar";
...
LAYOUT_NAMES="$(grep -oE '^dist/ui/layout/[^/]+' "$WORK/shipped.txt" | sed 's|.*/||' | sort -u)"
{
  ...
  echo 'import { buttonVariants } from "@tev-ui/ui/primitives/Button";'
  echo 'import { badgeVariants } from "@tev-ui/ui/primitives/Badge";'
  echo 'import { toggleVariants } from "@tev-ui/ui/primitives/Toggle";'
  echo 'import { FormFieldContext, FormItemContext, useFormField } from "@tev-ui/ui/primitives/Form";'
  echo 'import { CalendarDayButton } from "@tev-ui/ui/primitives/Calendar";'
  echo 'import { ScrollBar } from "@tev-ui/ui/primitives/ScrollArea";'
  echo 'import { gradientButtonVariants } from "@tev-ui/ui/brand/GradientButton";'
  echo 'import { DockShape, buildActionDockPath, ACTION_DOCK_HEIGHT } from "@tev-ui/ui/layout/ActionDock";'
  echo 'import { DataTableEmptyRow, DataTablePagination, DATA_TABLE_HEADER_VARIANTS, ROW_CLASS, useDataTablePagination, useTableScrollReset } from "@tev-ui/ui/brand/DataTable";'
  echo 'import { CustomRangePanel, DateCell, presetRange, DEFAULT_MONTHS } from "@tev-ui/ui/brand/DateRangePicker";'
  echo 'import { NotificationHeader, NotificationItem, NotificationList, relativeTime } from "@tev-ui/ui/brand/NotificationBell";'
  echo 'import { TourScrim, TourSpotlight, TourStepCard, TourStepDots, TourStepNav, placeStepCard } from "@tev-ui/ui/brand/ProductTour";'
  echo 'import { HomeIcon, NotificationBellIcon } from "@tev-ui/ui/brand/Icons";'
  ...
  echo 'import type { CalendarProps } from "@tev-ui/ui/primitives/Calendar";'
  echo 'import type { TableProps } from "@tev-ui/ui/primitives/Table";'
  echo 'import type { DataTableProps, DataTableColumn } from "@tev-ui/ui/brand/DataTable";'
  echo 'import type { DateRangePickerProps } from "@tev-ui/ui/brand/DateRangePicker";'
  echo 'import type { NotificationItemData } from "@tev-ui/ui/brand/NotificationBell";'
  echo 'import type { GradientButtonProps } from "@tev-ui/ui/brand/GradientButton";'
  echo 'import type { ProductTourProps } from "@tev-ui/ui/brand/ProductTour";'
  echo 'import type { AppLayoutProps } from "@tev-ui/ui/layout/AppLayout";'
